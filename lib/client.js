...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      '.hdcp-root{position:fixed;top:70px;right:16px;width:330px;max-width:calc(100vw - 32px);max-height:calc(100vh - 32px);pointer-events:auto;font:12px/1.5 system-ui,-apple-system,Segoe UI,sans-serif;color:var(--dsw-alias-label-primary,#e9e9ef);}',
      ...
      '.hdcp-body{padding:10px;border-top:1px solid var(--dsw-alias-border-l2,#3a3d46);flex:1 1 auto;display:flex;flex-direction:column;min-height:0;overflow:auto;max-height:calc(100vh - 140px);}',
