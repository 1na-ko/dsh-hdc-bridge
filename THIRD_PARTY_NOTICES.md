...
The knowledge excerpts are verbatim (unmodified) copies of the most-used API
references and app-model/ArkTS guides from the OpenHarmony documentation project,
