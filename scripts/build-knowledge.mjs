...
const MANIFEST = [
  ...
  { id: 'hilog', kind: 'module', module: '@ohos.hilog', path: 'reference/apis-performance-analysis-kit/js-apis-hilog.md', tags: ['日志', 'hilog', '调试'] },
  { id: 'abilityManager', kind: 'module', module: '@ohos.app.ability.abilityManager', path: 'reference/apis-ability-kit/js-apis-app-ability-abilityManager.md', tags: ['ability管理', '拉起应用'] },
  { id: 'window', kind: 'module', module: '@ohos.window', path: 'reference/apis-arkui/arkts-apis-window.md', tags: ['窗口', 'window'] },
  { id: 'window-Window', kind: 'class', module: '@ohos.window', path: 'reference/apis-arkui/arkts-apis-window-Window.md', tags: ['窗口', 'window', 'Window类'], sections: { include: [
    '=showWindow',
    '=destroyWindow',
    '=moveWindowTo',
    '=resize',
  ...
  { id: 'Navigation', kind: 'component', module: 'Navigation', path: 'reference/apis-arkui/arkui-ts/ts-basic-components-navigation.md', tags: ['navigation', '导航', 'NavPathStack', 'NavDestination'], sections: { include: [
    '子组件',
    '=接口',
    '=title',
    '=menus',
